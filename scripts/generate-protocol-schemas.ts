...
await Promise.all([
  ...
  writeSchema("web-content-get-request.schema.json", WebContentGetRequestSchema),
  writeSchema("web-content-get-response.schema.json", WebContentGetEnvelopeSchema),
