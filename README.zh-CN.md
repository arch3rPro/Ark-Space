...
**0.1.2 是 Preview Update。** 在保留 0.1.0 的 Provider-backed Web、Research、Browser、Monitor 与 MCP 能力基础上，新增由人控制的本地凭证配置、更清晰的 Skill 路由与结果处理、Activation 与 Isolation 验证，以及 Installation-first 文档。
