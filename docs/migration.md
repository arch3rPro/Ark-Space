...
Build a new ArkSpace project at `/Users/wangyu19/Documents/Vibe-Coding/code/Ark-Space` without modifying the existing implementation in place. The existing repository remains a read-only source of behavioral evidence until the replacement satisfies its acceptance gates.
